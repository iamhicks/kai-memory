...
const baseProgression = (thresholds: Advisor['progression']['thresholds']): Advisor['progression'] => ({
  thresholds,
...
export const coreAdvisors: Advisor[] = [
  {
    id: 'strategist',
    name: 'The Strategist',
    emoji: '🎯',
...
export const getAdvisorById = (id: string): Advisor | undefined =>
  coreAdvisors.find((advisor) => advisor.id === id);

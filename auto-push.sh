...
#   quick - Only Kai Memory + Sessions (default for cron)
#   full - Everything including Obsidian + products (manual)
...
# FULL MODE ONLY: Obsidian + Products
if [ "$MODE" == "full" ]; then
    echo ""
    echo "=== FULL BACKUP MODE ==="
    
    # 4. Backup Obsidian vault
    echo "[4/6] Backing up Obsidian..."
    ...
    # 7. Sync memory files to Obsidian
